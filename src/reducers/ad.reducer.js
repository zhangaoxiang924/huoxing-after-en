...
const adInfo = (state = {selectedData: {}, filter: {status: '', adPcPlace: '', adMobilePlace: ''}, search: {'nickName': '', 'title': '', 'type': 'init'}, pageData: {'currPage': 1, 'pageSize': 20, 'totalCount': 0}, query: {}, list: [], userInfo: {'name': '', 'pwd': ''}, info: {}, replyList: []}, action) => {
