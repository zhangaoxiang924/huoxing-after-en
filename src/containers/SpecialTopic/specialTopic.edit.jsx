...
import {getSpecialTopicItemInfo} from '../../actions/specialTopic.action'
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    >
                        <div className="dropbox">
                            ...
                            <span className="cover-img-tip">用于 pc 端新首页推荐的封面图展示, 长宽比例: <font style={{color: 'red'}}>50 * 50</font></span>
                        </div>
                    </FormItem>
