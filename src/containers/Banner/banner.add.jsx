...
import {getBannerItemInfo} from '../../actions/banner'
...
class BannerSend extends Component {
    ...
    componentWillMount () {
        ...
        if (location.query.id) {
            ...
            dispatch(getBannerItemInfo({'id': location.query.id}, (data) => {
                this.setState({
                    ratio: data.position === 1 ? '600px * 415px' : '560px * 200px',
    ...
    positionOnChange = (e) => {
        ...
        this.setState({
            position: value,
            ratio: value === '2' ? '560px * 200px' : '600px * 415px',
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    >
                        <div className="dropbox">
                            ...
                            <span className="cover-img-tip">用于 pc 端封面图展示, 长宽比例: <font style={{color: 'red'}}>{this.state.ratio}</font></span>
                        </div>
                    </FormItem>
                    <FormItem
                        {...formItemLayout}
                    ...
                    >
                        <div className="dropbox">
                            ...
                            <span className="cover-img-tip">用于 手机端 封面图展示, 长宽比例: <font style={{color: 'red'}}>750 * 488</font></span>
                        </div>
                    </FormItem>
