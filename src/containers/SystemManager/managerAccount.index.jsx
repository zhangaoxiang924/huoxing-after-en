...
import {getManagerAccountList, setSearchQuery, setPageData, addAccount, selectData} from '../../actions/managerAccount.action'
...
class ManagerAccountIndex extends Component {
    ...
    render () {
        const {list, pageData, dispatch, form} = this.props
        ...
        return <div className="managerAccount-index">
            ...
            <Modal
                ...
                footer={[
                    ...
                    <Button disabled={!this.state.authorInfo.passportId} key="submit" type="primary" onClick={() => { this.submitAccount() }}>添加</Button>
                ]}
            >
                <Form>
