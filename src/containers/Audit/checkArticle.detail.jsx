...
class ArticleAuditDetail extends Component {
    ...
    handleSubmit = (e) => {
        ...
        e.preventDefault()
        const {info} = this.props
        if (status === '1' && !isJsonString(info.coverPic)) {
                        ...
                        onOk () {
                            ...
                            if (_this.state.reason.trim() !== '') {
                                axiosAjax('POST', '/news/nopass', {
                                    ...
                                    if (res.code === 1) {
                                        axiosAjax('POST', '/news/status', {id: info.id, status: 2}, (res) => {
                                            if (res.code === 1) {
            ...
            {info.id ? <div className="post-detail">
                ...
                <Row className="news-summary">
                    <Col className="section">
                        ...
                        {
                            !info.audio || info.audio.indexOf(`[`) === -1 ? (
                ...
                <Row className="news-summary">
                    <Col className="section">
                        ...
                        {
                            !info.video || info.video.indexOf(`[`) === -1 ? (
