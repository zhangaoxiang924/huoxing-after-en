...
class PostSend extends Component {
    ...
    sendPost = (sendData) => {
        ...
        let style = `<style type="text/css"> .details .details-cont p, p {word-break: ${wordBreak ? 'break-all !important' : 'normal'};} </style>`
        let _data = {
                    ...
                    */}
                    ...
                    >
                        {getFieldDecorator('synopsis', {
                            ...
                            rules: [{max: 200, required: true, message: '请输入新闻内容摘要, 最多200字！'}]
                        })(
                            <TextArea className="news-summary" placeholder="新闻摘要, 最多200字"/>
                        )}
                    </FormItem>
